...
import (
	...
	"github.com/wansui976/go_zero_shop/apps/pay/rpc/internal/server"
...
var configFile = flag.String("f", "apps/pay/rpc/etc/pay.yaml", "the config file")
...
func main() {
	...
	fmt.Printf("Starting pay rpc server at %s...\n", c.ListenOn)
	s.Start()
}
