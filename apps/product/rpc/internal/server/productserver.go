...
import (
	...
	"github.com/wansui976/go_zero_shop/apps/product/rpc/internal/logic"
...
func (s *ProductServer) ProductAllList(ctx context.Context, in *product.ProductAllListRequest) (*product.ProductAllListResponse, error) {
	l := logic.NewProductAllListLogic(ctx, s.svcCtx)
	return l.ProductAllList(in)
}
