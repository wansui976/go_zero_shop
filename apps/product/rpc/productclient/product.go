...
type (
	...
	DecrProduct                 = product.DecrProduct
	...
	ProductAllListRequest       = product.ProductAllListRequest
	ProductAllListResponse      = product.ProductAllListResponse
...
func (m *defaultProduct) ProductAllList(ctx context.Context, in *ProductAllListRequest, opts ...grpc.CallOption) (*ProductAllListResponse, error) {
	client := product.NewProductClient(m.cli.Conn())
	return client.ProductAllList(ctx, in, opts...)
}
