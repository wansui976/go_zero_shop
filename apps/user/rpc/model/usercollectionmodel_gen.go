...
func (m *defaultUserCollectionModel) FindOne(ctx context.Context, id uint64) (*UserCollection, error) {
	...
	err := m.QueryRowCtx(ctx, &resp, userCollectionIdKey, func(ctx context.Context, conn sqlx.SqlConn, v any) error {
...
func (m *defaultUserCollectionModel) FindOneByUidProductId(ctx context.Context, uid uint64, productId uint64) (*UserCollection, error) {
	...
	var resp UserCollection
	err := m.QueryRowIndexCtx(ctx, &resp, userCollectionUidProductIdKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v any) (i any, e error) {
