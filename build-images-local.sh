...
echo "🐳 使用 Docker 打包镜像"
build_image "user-rpc" "${ROOT_DIR}/Dockerfile/Dockerfile.user"
build_image "product-rpc" "${ROOT_DIR}/Dockerfile/Dockerfile.product"
build_image "order-rpc" "${ROOT_DIR}/Dockerfile/Dockerfile.order"
build_image "reply-rpc" "${ROOT_DIR}/Dockerfile/Dockerfile.reply"
build_image "seckill-rpc" "${ROOT_DIR}/Dockerfile/Dockerfile.seckill"
build_image "api-gateway" "${ROOT_DIR}/Dockerfile/Dockerfile.api"
